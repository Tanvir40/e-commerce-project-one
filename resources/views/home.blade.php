            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Today Sales</h5>
                        <h3 class="mt-3 mb-3">{{$today_sales}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Present Day</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Yesterday sales</h5>
                        <h3 class="mt-3 mb-3">{{$yesterday_sales}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Previous Day</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">weekly Total Sales</h5>
                        <h3 class="mt-3 mb-3">{{$this_week_sales}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Last 7 Days</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Monthly Total sales</h5>
                        <h3 class="my-3 mx-3">{{$this_month_sales}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Last 30 Days</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Today Orders</h5>
                        <h3 class="mt-3 mb-3">{{$today_orders}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Present Day</b></span>
                        </p>
                ...
                <div class="card widget-flat">
                    <div class="card-body">
                       ...
                       <a href="{{route('pending.orders')}}">
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">All Pending Orders</h5>
                        <h3 class="mt-3 mb-3">{{$All_pending_orders}}</h3>
                       </a>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Pending Orders</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Total Coupon Discount</h5>
                        <h3 class="mt-3 mb-3">{{$total_discount}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Last 30 Days</b></span>
                        </p>
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h3 class="my-3 mx-3">{{$total_customer}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Regestered Customres</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                       ...
                       <a href="{{route('pending.orders')}}">
                        <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Total Available Product</h5>
                        <h3 class="mt-3 mb-3">{{$total_active_product}}</h3>
                       </a>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of All Available Products</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-warning fw-normal mt-0" title="Number of Customers">Stock out Product</h5>
                        <h3 class="mt-3 mb-3 text-warning">{{$total_out_of_stock_product}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Stock-out Products</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 mt-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-warning fw-normal mt-0" title="Number of Customers">Stock Out Warning Products</h5>
                        <h3 class="my-3 mx-3 text-warning">{{$total_stock_Warn_product}}</h3>
                        <p class="mb-0 text-muted">
                            {{-- <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 5.27%</span> --}}
                            <span class="text-nowrap"><b>Total Calculation of Quantity Less than 2</b></span>
                        </p>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div> <!-- end col-->
                ...
                {{-- <div class="col-sm-3">
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <h3 class="fs-14 mb-2">Today Sales</h3>
                                    <span class="title text-black font-w600">{{$today_sales}}</span>
                                </div>
                            </div>
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body ">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <h3 class="fs-14 mb-2">Yesterday sales</h3>
                                    <span class="title text-black font-w600">{{$yesterday_sales}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-secondary" style="width: 62%; height:5px;" role="progressbar">
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <h3 class="fs-14 mb-2">weekly Total Sales</h3>
                                    <span class="title text-black font-w600">{{$this_week_sales}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-danger" style="width: 78%; height:5px;" role="progressbar">
                                    <span class="sr-only">42% Complete</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <p class="fs-14 mb-2">Monthly Total sales</p>
                                    <span class="title text-black font-w600">{{$this_month_sales}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-warning" style="width: 88%; height:5px;" role="progressbar">
                                    <span class="sr-only">42% Complete</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <h3 class="fs-14 mb-2">Today Orders</h3>
                ...
                {{-- <div class="col-sm-3">
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <a href="{{route('pending.orders')}}"><div class="card-body ">
                            <div class="media align-items-center">
                                <span class="activity-icon bgl-secondary  mr-md-4 mr-3">
                                    <svg width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.64826 26.5285C0.547125 26.7394 -0.174308 27.8026 0.0366371 28.9038C0.222269 29.8741 1.07449 30.5491 2.02796 30.5491C2.15453 30.5491 2.28531 30.5364 2.41188 30.5112L10.7653 28.908C11.242 28.8152 11.6682 28.5578 11.9719 28.1781L15.558 23.6554L14.3599 23.0437C13.4739 22.5965 12.8579 21.7865 12.6469 20.8035L9.26338 25.0688L1.64826 26.5285Z" fill="#A02CFA"/>
                                ...
                                <div class="media-body">
                                    <h3 class="fs-14 mb-2">All Pending Orders</h3>
                                    <span class="title text-black font-w600">{{$All_pending_orders}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-secondary" style="width: 62%; height:5px;" role="progressbar">
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <h3 class="fs-14 mb-2">Monthly Total Coupon Discount</h3>
                                    <span class="title text-black font-w600">{{$total_discount}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-danger" style="width: 78%; height:5px;" role="progressbar">
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <p class="fs-14 mb-2">Total Available Product</p>
                                    <span class="title text-black font-w600">{{$total_active_product}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-success" style="width: 42%; height:5px;" role="progressbar">
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <p class="fs-14 mb-2">Stock out Product</p>
                                    <span class="title text-black font-w600">{{$total_out_of_stock_product}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-danger" style="width: 78%; height:5px;" role="progressbar">
                    ...
                    <div class="card avtivity-card shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <p class="fs-14 mb-2">stock Out warning (Product < 2)</p>
                                    <span class="title text-black font-w600">{{$total_stock_Warn_product}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-warning" style="width: 88%; height:5px;" role="progressbar">
                ...
                <div class="col-lg-6 mt-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <canvas id="myCharte" width="400" height="250"></canvas>
                        </div>
                    </div>
                 </div>
                ...
                <div class="col-lg-6 mt-5">
                    <div class="card">
                        <div class="card-header">
                            <h3>Total Product Order Chart</h3>
                        </div>
                        <div class="card-body">
                            <canvas id="myCharte2" width="400" height="250"></canvas>
                        </div>
                    </div>
                 </div>
                    ...
                    <div class="col-lg-12 my-5">
                        <h2 class="text-black text-center">Order Sales Report</h2>
                        <p class="text-black text-center">Search Sales Report by Date</p>
                        <hr>
                    </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('search-by-month') }}" method="POST" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control mb-2 select2" name="year_name" data-placeholder="Choose one" data-validation="required">
                                        <option label="Choose one"></option>
...
<script>
    ...
    const myCharte = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ['Today Order', 'Yesterday Orders', 'Last 7 days Orders', 'Last 30 days Orders'],
            datasets: [{
                label: 'Total Number Of Orders',
                data: [{{$today_orders}} ,{{$yesterday_orders}},{{$this_week_orders}}, {{$this_month_orderss}},],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
...
<script>
    //for pie chart
    const ctx2 = document.getElementById('myCharte2');
    const myCharte2 = new Chart(ctx2, {
        type: 'pie',
        data: {
            labels: ['Today Order Items', 'Yesterday Orders Items', 'Last 7 days Orders Items', 'Last 30 days Orders Items'],
            datasets: [{
                label: 'Total Number Of Order Products',
                data: [{{$today_orders_product}} ,{{$yesterday_orders_product}},{{$this_week_orders_product}}, {{$this_month_orders_product}},],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
