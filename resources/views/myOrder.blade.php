    ...
    <div class="row mt-5">
        <div class="col-md-4 order-md-2 mb-4 m-auto">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                <span class="text-muted">Contine For Payment With Paypal</span>
            </h4>
            <form action="{!! URL::to('paypal') !!}" method="POST" class="needs-validation">
                @csrf
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (BDT)</span>
                    <input type="hidden" name="amount" value="{{$data['subtotal'] -$data['discount'] + ($data['charge'])}}">
