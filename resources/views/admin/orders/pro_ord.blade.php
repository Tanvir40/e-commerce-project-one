...
@section('content')
@can('show_processing_orders')
{{-- breadcrumb start--}}
<div class="page-titles">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Processing Orders</a></li>
    </ol>
    </div>
    {{-- breadcrumb end --}}
    @endcan
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                        @if (session('delevered'))
                            <div class="alert alert-success"><strong>{{session('delevered')}}</strong></div>
                        @endif
                        @if (session('cencel'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="Update Order">
                                    ...
                                    <input type="hidden" name="grandtotal" value="{{$order->rel_to_order->total}}">
                                    <input type="hidden" name="charge" value="{{$order->rel_to_order->charge}}">
