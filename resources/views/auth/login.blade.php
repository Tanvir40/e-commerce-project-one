...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Log In | Tonmoy - Admin Dashboard</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="A fully featured admin theme which can be used to build CRM, CMS, etc." name="description" />
        <meta content="Coderthemes" name="author" />
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{asset('/backend/images/logo_sm_dark.png')}}">
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                @if (session('inactive'))
                                    <div class="alert alert-warning text-black">{{session('inactive')}}</div>
                                @endif
                                ...
                                @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            id="password" @error('password') is-invalid @enderror" name="password" autocomplete="current-password">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Don't have an account? <a href="{{url('/register/admin')}}" class="text-muted ms-1"><b>Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
